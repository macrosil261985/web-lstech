...
-->
		...
		<a href="./?view=newreservation" class="btn btn-default pull-right">Nueva orden de servicio</a>
		<br><br>
		...
		?>
			...
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input type="date" name="sdate_at" value="<?php if(isset($_GET["sdate_at"]) && $_GET["sdate_at"]!=""){ echo $_GET["sdate_at"]; } ?>" class="form-control" placeholder="Fecha">
				</div>
				</div>
